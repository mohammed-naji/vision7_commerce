...
<body>
    <section class="flex flex-col md:flex-row h-screen items-center">
        ...
        <div class="bg-blue-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen">
            <img src="https://images.unsplash.com/photo-1601598851547-4302969d0614?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1964&q=80"
        ...
        <div
            ...
            <div class="w-full h-100">
                ...
                <form class="mt-6" action="{{ route('login') }}" method="POST">
                    ...
                    <div>
                        ...
                        <input type="email" name="" id="email" placeholder="Enter Email Address"
                            ...
                            <input id="email" type="email" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" name="email" value="{{ old('email') }}" autocomplete="email" autofocus>
                ...
                <p class="text-sm text-gray-500 mt-12">&copy; {{ date('Y') }} {{ config('app.name') }} - All Rights Reserved.</p>
            </div>
        </div>
